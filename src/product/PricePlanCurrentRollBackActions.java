...
public class PricePlanCurrentRollBackActions {
	...
	public int activation(int step, ProductProperties productProperties, DAO dao, String msisdn, boolean charged) {
		...
		if((step < 4) || (productProperties.getPamServiceID() > 99) || (productProperties.getPamServiceID() < 0) || (request.deletePeriodicAccountManagementData(msisdn, pamInformationList, "eBA", true))) {
	...
	public int deactivation(int step, ProductProperties productProperties, DAO dao, String msisdn, boolean charged) {
		...
		if((step < 4) || ((productProperties.getPamServiceID() > 99) || (productProperties.getPamServiceID() < 0) || (request.addPeriodicAccountManagementData(msisdn, pamInformationList, true, "eBA")))) {
			step = (step < 4) ? step : (step-1);
