	...
	public Object [] getStatus(ProductProperties productProperties, MessageSource i18n, DAO dao, String msisdn, int language, boolean bonus) {
		...
		if((statusCode == 0) && bonus) {
			...
			if((bonusSMS != null) && (bonusNight != null)) {
				message = i18n.getMessage("status.successful_with_bonus", new Object[] {(int)(bonusSMS[0]), (String)(bonusSMS[1]), (int)(bonusNight[0]), (int)(bonusNight[1]), (bonusNight[2]), (String)(bonusNight[3]), (String)(bonusNight[4])}, null, (language == 2) ? Locale.ENGLISH : Locale.FRENCH);
			}
				...
				message = i18n.getMessage("status.successful_with_bonus_only_night_advantages", new Object[] {(int)(bonusNight[0]), (int)(bonusNight[1]), (bonusNight[2]), (String)(bonusNight[3]), (String)(bonusNight[4])}, null, (language == 2) ? Locale.ENGLISH : Locale.FRENCH);
			}
	...
	public Object[] getNightAdvantages(ProductProperties productProperties, String msisdn, int language) {
		try {
			...
			if((balanceBonusCall != null) && (balanceBonusData != null)) {
				...
				if(volumeData >= 1024) {
					return new Object[] {volumeVoice/60, volumeVoice%60, new Formatter().format("%.2f", ((double)volumeData/1024)), (language == 2) ? "GB" : "Go", (new SimpleDateFormat("HH'H'mm")).format(balanceBonusData.getExpiryDate())};
				}
				else {
					return new Object[] {volumeVoice/60, volumeVoice%60, volumeData, (language == 2) ? "MB" : "Mo", (new SimpleDateFormat("HH'H'mm")).format(balanceBonusCall.getExpiryDate())};
				}
			}
			else if(balanceBonusCall != null) {
				long volumeVoice = balanceBonusCall.getAccountValue()/100;
				return new Object[] {volumeVoice/60, volumeVoice%60, 0, (language == 2) ? "MB" : "Mo", (new SimpleDateFormat("HH'H'mm")).format(balanceBonusCall.getExpiryDate())};
			}
