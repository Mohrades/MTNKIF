...
public class AddToneBox {
	...
	public AddToneBox(String host, int sleep, int timeout) {
	...
	public HashMap<String, String> execute(String portalType, String moduleCode, String role, String roleCode, String loopToneType, String name, String toneBoxCode, String[] toneCodes, String[] toneIDs, String[] toneTypes, String type, String feeType, String price, String phoneNumber, boolean waitingForResponse) {
