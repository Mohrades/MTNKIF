...
public class QueryInboxTone {
	...
	public QueryInboxTone(String host, int sleep, int timeout) {
	...
	public HashMap<String, String> execute(String portalType, String moduleCode, String role, String roleCode, String phoneNumber, String startRecordNum, String endRecordNum, String queryType, String merchantID, String serviceID, String resourceCode, String resourceID, String resourceType, String status, String orderType, String orderBy, String smAccessCode, boolean waitingForResponse) {
