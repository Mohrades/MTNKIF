...
public class DelInboxTone {
	...
	public DelInboxTone(String host, int sleep, int timeout) {
	...
	public HashMap<String, String> execute(String portalType, String moduleCode, String role, String roleCode, String phoneNumber, String personId, String merchantID, String serviceID, String resourceCode, String resourceID, String resourceType, boolean waitingForResponse) {
