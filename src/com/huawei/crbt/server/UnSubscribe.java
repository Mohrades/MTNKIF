...
public class UnSubscribe {
	...
	public UnSubscribe(SocketConnection connection) {
		this.connection = connection;
	}

	public HashMap<String, String> execute(String portalType, String moduleCode, String role, String roleCode, String phoneNumber) {
		...
		try {
			if((connection != null) && (connection.isOpen())) {
				...
				rawResponse = connection.submitRequest("/jboss-net/services/UserManage", rawQuery);
			}
