...
public class OrderTone {
	...
	public OrderTone(SocketConnection connection) {
		this.connection = connection;
	}

	public HashMap<String, String> execute(String portalType, String moduleCode, String role, String roleCode, String phoneNumber, String recommendNumber, String resourceCode, String resourceType, String discount, String reorderMode, String smAccessCode) {
